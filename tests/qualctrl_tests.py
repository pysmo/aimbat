...
from pysmo.aimbat.qualctrl import (
    PickPhaseMenuMore,
    getAxes,
    getDataOpts,
    getOptions,
...
class qualctrlView:
    ...
    class filterClass(unittest.TestCase):
        ...
        def test_filter_getLowFreq(self):
            ...
            fake_event = matplotlib.backend_bases.LocationEvent(
                "button_press_event", ppmm.figfilter.canvas, 370, 266
            )
        ...
        def test_filter_getBandpassFreq(self):
            ...
            # first click
            eventA = matplotlib.backend_bases.LocationEvent(
                "button_press_event", ppmm.figfilter.canvas, 370, 266
            )
            ...
            # second click
            eventB = matplotlib.backend_bases.LocationEvent(
                "button_press_event", ppmm.figfilter.canvas, 371, 267
            )
        ...
        def test_filter_applyFilter(self):
            ...
            fake_event = matplotlib.backend_bases.MouseEvent(
                "button_press_event", ppmm.figfilter.canvas, 636, 823
            )
        ...
        def test_filter_unapplyFilter(self):
            ...
            event_apply = matplotlib.backend_bases.MouseEvent(
                "button_press_event", ppmm.figfilter.canvas, 636, 823
            )
            ppmm.applyFilter(event_apply)

            event_unapply = matplotlib.backend_bases.MouseEvent(
                "button_press_event", ppmm.figfilter.canvas, 538, 838
            )
