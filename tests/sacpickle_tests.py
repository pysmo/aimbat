...
from pysmo.aimbat.sacpickle import (
    SacGroup,
    fileZipMode,
    pkl2sac,
    readPickle,
...
class sacpickleModel(unittest.TestCase):
    ...
    @unittest.skip(
        "savesac() writes a fixed header list (o, cmpaz, cmpinc, kcmpnm) absent from this "
        "legacy Python 2 pickle fixture; pre-existing data drift, unrelated to modernisation."
    )
    ...
    def test_sac2pkl(self):
        if os.path.isfile(
            "sac2pkl_files/Event_2011.09.15.19.31.04.080/20110915.19310408.bhz.pkl"
        ):
            os.remove(
                "sac2pkl_files/Event_2011.09.15.19.31.04.080/20110915.19310408.bhz.pkl"
            )
        ...
        ifiles = [
            "sac2pkl_files/Event_2011.09.15.19.31.04.080/AR.113A.__.BHZ",
