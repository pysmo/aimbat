...
def seisApplyFilter(saclist, filtParas):
    ...
    for sacdh in saclist:
        ...
        filtDataT, filtDataF, adjw, adjh = ftr.filtering_time_freq(origTimeT, origDataT, sacdh.delta, filtParas['band'],
                                                                   filtParas['highFreq'], filtParas['lowFreq'],
                                                                   filtParas['order'], filtParas['reversepass'])
