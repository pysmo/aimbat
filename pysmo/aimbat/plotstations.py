...
class PlotStations:
    ...
    def plot_stations(self, gsac):
        ...
        h = 1.2 * 6370997.0 * np.radians(maxLat - minLat)
        w = 1.1 * 6370997.0 * np.radians(maxLon - minLon) * np.cos(np.radians(qLat))
        ...
        if basemapthere:
            ...
            simplexmin = minLon - 1.0
            simplexmax = maxLon + 1.0
            simpleymin = minLat - 1.0
            simpleymax = maxLat + 1.0
    ...
    def plot_selected_stations(self, axes_handle):
        ...
        if basemapthere:
            ...
            axes_handle.scatter(
                selected_lon, selected_lat, s=50, marker="o", c="r", picker=True
            )
    ...
    def plot_deleted_stations(self, axes_handle):
        ...
        if basemapthere:
            ...
            axes_handle.scatter(
                deleted_lon, deleted_lat, s=50, marker="^", c="k", picker=True
            )
